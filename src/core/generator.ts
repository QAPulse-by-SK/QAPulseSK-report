  ...
  return `
    <div class="suite" ${indent}>
      <div class="suite-header">
        ...
        <span class="suite-meta">${suite.tests.length} tests · ${formatDuration(suite.duration)}</span>
      </div>
...
<main class="container">
  ...
  <div class="stats-grid">
    ...
    <div class="stat-card">
      ...
      <div class="stat-value" style="font-size:20px">${formatDuration(stats.duration)}</div>
    </div>
    <div class="stat-card">
...
export function writeReport(html: string, outputDir: string, filename = 'qapulse-report.html'): string {
